                ...
                <div class="col-12">
                    <h6 style="color: #a99191;"><a href="#" style="color: #9da2a9;text-decoration: none;">Product</a>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black"
                            ...
                            <path
                                d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z" />
                        </svg> <span style="color: blue;">Earphone</span>
                    </h6>
                </div>
            </div>
    </section>
    ...
    <form action="" method="post">
        <div class="container" style="    background-color: whitesmoke;"><br>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="compatible_device" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="hardware_platform" class="form-control">
                </div>
                <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="amplifire_type" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="battery_cell" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="microphone_format" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <h6>Headphones form factor :-</h6>
                </div>
                <div class="col-6">
                    Batteries Included :-
                </div>
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="headphone_form_factor" class="form-control">
                </div>
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="battries_required" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="cell_required" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
