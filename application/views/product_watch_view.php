                ...
                <div class="col-12">
                    <h6 style="color: #a99191;"><a href="#" style="color: #9da2a9;text-decoration: none;">Product</a>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black"
                            ...
                            <path
                                d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z" />
                        </svg> <span style="color: blue;">Watch</span>
                    </h6>
                </div>
            </div>
    </section>
    ...
    <form action="" method="post">
        <div class="container" style="    background-color: whitesmoke;"><br>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="item_height" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="item_width" class="form-control">
                </div>
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="connectivity_type" class="form-control">
                </div>
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <h6>Average Battery Life (in hours):-</h6>
                </div>
                <div class="col-6">
                    Included Components :-
                </div>
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="battrey_life" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="include_component" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="batteries" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="battery_charge_time" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="Lithium_Ion_Cells" class="form-control">
                </div>
                <div class="col-6">
