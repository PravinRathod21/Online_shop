...
<body>
                ...
                <div class="col-12">
                    <h6 style="color: #a99191;"><a href="#" style="color: #9da2a9;text-decoration: none;">Product</a>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black"
                            ...
                            <path
                                d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z" />
                        </svg> <span style="color: blue;">TV</span>
                    </h6>
                </div>
            </div>
    </section>
    ...
    <form action="" method="post">
        <div class="container" style="    background-color: whitesmoke;"><br>
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="memorey_capacity" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="ram_installed_size" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="opreating_system" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="hardware_interface" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="batteries_include" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="rechargable_battery" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <h6>Includes remote:-</h6>
                </div>
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="include_remote" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="support_bluthooth" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <h6>Graphics Coprocessor :-</h6>
                </div>
                <div class="col-6">
                    Tuner Technology :-
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="tuner_technology" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="special_feature" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text"  name="mounting_hardware" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="number_of_item" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text"  name="display_technology"class="form-control">
                </div>
                <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="viewing_angle" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="support_image_type" class="form-control">
                </div>
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text"  name="audio_encoding"class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="support_audio_format" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <h6>Speakers Maximum Output Power :-</h6>
                </div>
                <div class="col-6">
                    Audio Wattage :-
                </div>
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="speaker_output_power" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="audio_wattage"class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="gsm_frquencies"class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input type="text" name="usb_ports"class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <h6>Connector Type :-</h6>
                </div>
                <div class="col-6">
                    Mounting Type:-
                </div>
            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="connector_type" class="form-control">
                </div>
                <div class="col-6">
                    <input type="text" name="mounting_type" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-6">
