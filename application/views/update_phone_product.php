    ...
    <form action="" method="post">
        ...
        foreach ($data as $row) {
            ...
            <div class="container" style="    background-color: whitesmoke;"><br>
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="opreating_system" class="form-control"  value="<?php echo $row->opreating_system?>" required>
                    </div>
                    <div class="col-6">
                        <input type="text" name="gpu" class="form-control"  value="<?php echo $row->gpu?>" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="ram" class="form-control"   value="<?php echo $row->ram?>" required>
                    </div>
                    <div class="col-6">
                        <input type="text" name="product_dimention" class="form-control"  value="<?php echo $row->product_dimention?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="battries" class="form-control"   value="<?php echo $row->battries?>" required>
                    </div>
                    <div class="col-6">
                        <input type="text" name=" wirless_communication_tech" class="form-control"  value="<?php echo $row->wirless_communication_tech?>"  required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="connectivity_technology" class="form-control"  value="<?php echo $row->connectivity_technology?>" required>
                    </div>
                    <div class="col-6">
                        <input type="text" name="special_feature" class="form-control" value="<?php echo $row->special_feature?>"  required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="display_technology" class="form-control"  value="<?php echo $row->display_technology?>"  required>
                    </div>
                    <div class="col-6">
                        <input type="text" name="other_display_feature" class="form-control"  value="<?php echo $row->other_display_feature?>" >
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="form_factor" class="form-control"  value="<?php echo $row->form_factor?>"  required>
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="battrey_rating" class="form-control"  value="<?php echo $row->battrey_rating?>" required>
                    </div>
                    <div class="col-6">
                        <input type="text" name="in_the_box" class="form-control"  value="<?php echo $row->in_the_box?>" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="manufacturing" class="form-control"  value="<?php echo $row->manufacturing?>" required>
                    </div>
                    <div class="col-6">
                        <input type="text" name="country_of_origin" class="form-control"  value="<?php echo $row->country_of_origin?>" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="item_weight" class="form-control"   value="<?php echo $row->item_weight?>" required>
                    </div>
                    <div class="col-6">
                        <input type="text" name="model_number" class="form-control"  value="<?php echo $row->model_number?>" required>
                    </div>
                </div><br>
