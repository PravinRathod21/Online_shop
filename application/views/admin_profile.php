    ...
    <section id="Dashbord">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <h6 style="color: #a99191;"><a href="#" style="color: #9da2a9;text-decoration: none;">Admin </a>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black"
                            class="bi bi-caret-right-fill" viewBox="0 0 16 16" style="    margin-bottom: 2px;">
                            <path
                                d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z" />
                        </svg> <span style="color: blue;">Profile</span>
                    </h6>
                </div>
            </div>
        </div>

        <div class="container" style="background: whitesmoke;    text-align: center;border-radius: 2%;">
            <div class="row">
                <div class="col-12" style="    margin-top: 3%;">
                    <img src="http://localhost:8080/coreigniter_4/image/16.png" width="50" height="50"
                        style="    border-radius: 60%;">
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <h6 style=""><b>Admin</b> </h6>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <h6 style="">pravinrathod477854@gmail.com </h6>
                </div>
            </div><br>
        </div><br>
        ...
        <div class="container" style="">
            <div class="row">
                <div class="col-6" style="    width: 49%;background: whitesmoke; border-radius: 2%;  ">
                    <div class="row">
                        <div class="col-12" style="    margin-top: 3%;">
                            <h6 style=""><b>Admin information</b> </h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12" style="    margin-top: 4%;">
                            <h6 style="">Profile Picture :-</h6>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="col-6" style="     width: 49%;    margin-left: 2%;background: whitesmoke; border-radius: 2%;">
                    <div class="row">
                        <div class="col-12" style="    margin-top: 3%;">
                            <h6 style=""><b>Security information</b> </h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12" style="    margin-top: 4%;">
                            <h6 style="">Current Password</h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12" style=" ">
