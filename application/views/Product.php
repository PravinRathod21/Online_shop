                        ...
                        ?>
                            <div class='content'>
                                <div class='img-box'style='    margin-top: 8%;'>
                                    <a href="http://localhost:8080/coreigniter_4/Crud/view_info?id=<?php echo $row->id; ?>"><img style='width: 150px;height: 150px;'class='images' src="http://localhost:8080/coreigniter_4/Crud/image/<?php echo $row->image; ?>"></img></a>
                                </div>
            ...
            <div class="body">
                ...
                <?php
                            ...
                            ?>
                                <div class='content'>
                                    <div class='img-box'style='    margin-top: 8%;'>
                                        <a href="p"><img style='width: 100px;height: 100px;'class='images' src="<?php echo $row->image; ?>"></img></a>
                                    </div>
                                    <div class="add_to_card">
                                        <button style='height: 44px;width: 100%;background-color: #ffd13d;'>Buy Now</button>
                                    </div> <br>
