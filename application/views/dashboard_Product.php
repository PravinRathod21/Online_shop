...
<body>
    ...
    <div class="container product_table" style="    text-align: center;">
        <div class="row">
            <div class="col-12">
                <h3 style="    text-align: left;"><b>All Product</b></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-10">
            </div>
            <div class="col-2" id="add_prod">
                <button type="button" style="font-size: 72%;text-align: center;" class="btn btn-primary">Add
                    Product</button>
            </div>
        </div><br>
        <div class="row" id="types" style="display:none;">
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light " id="electronic">Electronic +</button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="sports">Sports +</button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="toy">Toy + </button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="food">Food +</button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="clothes">Clothes +</button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="home">Home +</button>
            </div>
        </div><br>
        <script>
            $(document).ready(function () {
                $("#electronic").click(function () {
                    ...
                    $("#electronic_types").toggle("display: none");
                });
            });
        </script>
        <div class="row" id="electronic_types" style="display:none;">
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light " id="phone">
                    <a href="http://localhost:8080/coreigniter_4/Crud/product_phone_view">Phone +</a>
                </button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="tv">
                    <a href="http://localhost:8080/coreigniter_4/Crud/product_tv_view">TV +</a>
                </button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="watch">
                    <a href="http://localhost:8080/coreigniter_4/Crud/product_watch_view">Watch +</a>
                </button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="earphone">
                    <a href="http://localhost:8080/coreigniter_4/Crud/product_earphone_view">Earphone +</a>
                </button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="laptop">
                    <a href="http://localhost:8080/coreigniter_4/Crud/product_laptop_view">Laptop +</a>
                </button>
            </div>
            <div class="col-2">
                <button type="button" class=" form-control btn btn-light" id="phone">Home +</button>
            </div>
        </div>
        ...
        foreach ($data as $row) {
            ...
            <div class="row">
                <div class="col-1">
                    <img src="http://localhost:8080/coreigniter_4/image/<?php echo $row->photo; ?>" width="30"
                        height="30">
                </div>
                <div class="col-2">
                    <p>
                ...
                <div class="col-1">
                    <a href="http://localhost:8080/coreigniter_4/Crud/update_phone_product?id=<?php echo $row->id  ?>">
                        <button class="form-control">
                            <svg xmlns="http://www.w3.org/2000/svg" class=" icon" width="16" height="16" fill="currentColor"
        ...
        foreach ($home as $row) {
            ...
            <div class="row">
                <div class="col-1">
                    <img src="http://localhost:8080/coreigniter_4/image/<?php echo $row->image; ?>" width="30" height="30">
                </div>
                <div class="col-2">
                    <p>
                        <?php echo $row->name; ?>
